...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println( LambdaLibrary.NUMBER_OF_EMPLOYEES_BY_SALARY.apply(list, 100000,'E'));
		...
		System.out.println( LambdaLibrary.LIST_OF_EMPLOYEES_BY_SALARY.apply(list, 85000, 'R'));
